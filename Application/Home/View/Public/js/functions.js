 ...
 * 线上使用加密压缩文件
	...
	//控制台输出
	console.log("%c%c我 諾哥 打钱%c3̶2̶8̶%c488%c","padding:49px 50px;line-height:100px;background:url('https://wuguangnuo-1257896087.cos.ap-guangzhou.myqcloud.com/public/img/alipay.jpg')no-repeat","font-family:'Microsoft YaHei';font-size:18px;font-weight:bold;padding:5px","font-family:'Microsoft YaHei';font-size:16px;font-weight:normal;padding:5px","font-family:'Microsoft YaHei';font-size:18px;font-weight:bold;color:red;padding:5px","padding:49px 50px;background:url('https://wuguangnuo-1257896087.cos.ap-guangzhou.myqcloud.com/public/img/wechat.png')no-repeat");
