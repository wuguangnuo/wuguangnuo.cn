...
<body>
<?php if(isset($e['trace']) || isset($e['file'])) {
	echo '<h2>' . strip_tags($e['message']) . '</h2>';
} ?>
<?php if(isset($e['file'])) {?>
	<div class="info">
		<div class="title">
		...
		<div class="error-page-actions">
			...
			<div>
				...
				<ol>
					...
					<li><a href="#">留言反馈</a></li>
					<li><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2391459282&site=qq&menu=yes">联系站长</a></li>
				</ol>
			</div>
		</div>
	</div>
